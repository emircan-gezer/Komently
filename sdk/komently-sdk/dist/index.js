...
function ReplyBox({
  ...
  if (!commenterToken) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-auth-prompt", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "You must be logged in to reply." }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-reply-box-container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "textarea",
      {
        ref: textareaRef,
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "komently-error-text", children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-reply-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
...
function CommentNode({
  ...
  const [comment, setComment] = (0, import_react.useState)(initialComment);
  const [collapsed, setCollapsed] = (0, import_react.useState)(false);
  const [replying, setReplying] = (0, import_react.useState)(false);
  const [voting, setVoting] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-comment-item", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-thread-line" })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-comment-content", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "komently-timestamp", children: [
              "\u2022 ",
              timeAgo(comment.createdAt)
            ] }),
            collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "komently-collapsed-badge", children: [
      ...
      !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-body-reveal", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "komently-comment-body", children: comment.body }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-comment-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            VoteAction,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-divider" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
        ...
        replying && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ReplyBox,
          {
            commenterToken,
        ...
        hasReplies && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-comment-replies", style: { marginTop: "0.5rem", display: "flex", flexDirection: "column", gap: "1rem" }, children: comment.replies.map((reply) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          CommentNode,
          {
            comment: reply,
            depth: depth + 1,
...
function NewCommentBox({
  ...
  if (!commenterToken) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-login-prompt", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "komently-login-text", children: "Sign in as a commenter to join the discussion." }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: onLogin, className: "komently-button-primary", children: "Login with Komently" })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-new-comment-container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "textarea",
      {
        value: body,
...
function CommenterProfileEditor({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-profile-editor", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-profile-editor-content", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { className: "komently-profile-editor-title", children: "Commenter Profile" }),
    error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "komently-error-text", children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-input-group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "komently-label", children: "Username" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          value: username,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-profile-editor-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
...
function CommentSection({
  ...
  const [isAuthLoaded, setIsAuthLoaded] = (0, import_react.useState)(false);
  const [loading, setLoading] = (0, import_react.useState)(true);
  const [sorting, setSorting] = (0, import_react.useState)("top");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-sdk-root", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-toolbar-title", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "komently-title", children: "Discussion" }),
        data && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "komently-count", children: data.totalCount })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-sorting-tabs", children: SORTINGS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          onClick: () => {
            setSorting(s);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-list", children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-loading-state", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-spinner" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "komently-loading-text", children: "awaiting response\u2026" })
    ] }) : data?.comments.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-empty-state", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The silence is loud." }) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-comments-wrapper", children: data?.comments.map((comment, i, arr) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
    ...
    data && data.totalPages > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-pagination", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          disabled: page === 1,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "komently-pagination-info", children: [
        page,
        " / ",
        data.totalPages
      ] }),
    ...
    me?.loggedIn && me?.commenter && !editingProfile && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-profile-bar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "komently-profile-info", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "komently-profile-avatar", style: { background: me.commenter.color }, children: me.commenter.avatar_initial }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "komently-profile-text", children: [
          "Commenting as ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: me.commenter.username })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
    ...
    editingProfile && me?.commenter && activeToken && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function init(options) {
  ...
  root.render(
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react2.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CommentSection, { ...props }) })
  );
}
function autoInit() {
  ...
  containers.forEach((el) => {
    ...
    if (publicId) {
      ...
      root.render(
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react2.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          CommentSection,
          {
            publicId,
            baseUrl,
