...
function Button(props) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("button", { ...rest, className: `komently-button ${className}`.trim() });
}
...
function Textarea(props) {
  const { className = "", ...rest } = props;
  return /* @__PURE__ */ import_react2.default.createElement("textarea", { ...rest, className: `komently-textarea ${className}`.trim() });
}
...
function Form(props) {
  const { className = "", ...rest } = props;
  return /* @__PURE__ */ import_react3.default.createElement("form", { ...rest, className: `komently-form ${className}`.trim() });
}
...
function CommentForm({ onSubmit, onLogin, isAuthenticated, currentUser, submitting, onLogout, allowGuestComments = false }) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(Form, { onSubmit: handleSubmit }, allowGuestComments && !isAuthenticated && /* @__PURE__ */ import_react4.default.createElement("div", { className: "komently-guest-message" }, /* @__PURE__ */ import_react4.default.createElement("p", { className: "komently-guest-text" }, "Comment as guest or ", /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", onClick: onLogin, className: "komently-guest-login-link" }, "login with Google, etc"))), isAuthenticated && /* @__PURE__ */ import_react4.default.createElement("div", { className: "komently-form-header" }, currentUser?.avatarUrl ? /* @__PURE__ */ import_react4.default.createElement("img", { src: currentUser.avatarUrl, alt: "avatar", className: "komently-avatar" }) : /* @__PURE__ */ import_react4.default.createElement("div", { className: "komently-avatar-fallback", title: "avatar" }, (currentUser?.username || currentUser?.firstName || "U").slice(0, 1).toUpperCase()), /* @__PURE__ */ import_react4.default.createElement("div", { className: "komently-user-name" }, currentUser?.firstName || currentUser?.username || currentUser?.email || "You"), onLogout && /* @__PURE__ */ import_react4.default.createElement(Button, { type: "button", onClick: onLogout, title: "Logout" }, /* @__PURE__ */ import_react4.default.createElement(import_lucide_react.LogOut, { size: 14 }))), /* @__PURE__ */ import_react4.default.createElement(
    Textarea,
    {
  ...
  ), /* @__PURE__ */ import_react4.default.createElement("div", { className: "komently-actions" }, !isAuthenticated && !allowGuestComments && /* @__PURE__ */ import_react4.default.createElement(Button, { type: "button", onClick: onLogin }, "Log in"), /* @__PURE__ */ import_react4.default.createElement(Button, { type: "submit", disabled: !canPost || submitting, className: "komently-button-primary" }, submitting ? "Posting\u2026" : "Post")));
}
...
function CommentItemBase({
  ...
  const [showReply, setShowReply] = (0, import_react5.useState)(false);
  const [showEdit, setShowEdit] = (0, import_react5.useState)(false);
  const [text, setText] = (0, import_react5.useState)("");
  const [editText, setEditText] = (0, import_react5.useState)(comment.comment);
  ...
  return /* @__PURE__ */ import_react5.default.createElement("div", { className: `komently-comment ${collapsed ? "collapsed" : ""}` }, comment.reply_to && /* @__PURE__ */ import_react5.default.createElement(
    "div",
    {
  ...
  ), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-comment-content" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-comment-header" }, /* @__PURE__ */ import_react5.default.createElement(Button, { type: "button", className: "komently-collapse-toggle", onClick: () => toggleCollapse(comment.id), "aria-label": "Toggle" }, collapsed ? /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.ChevronRight, { size: 16 }) : /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.ChevronDown, { size: 16 })), displayAvatar ? /* @__PURE__ */ import_react5.default.createElement("img", { src: displayAvatar, alt: "avatar", className: "komently-avatar" }) : /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-avatar-fallback", title: "avatar" }, (displayName || "U").slice(0, 1).toUpperCase()), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-comment-username" }, displayName), comment.edited_at && /* @__PURE__ */ import_react5.default.createElement("span", { className: "komently-edited-badge", title: `Edited ${new Date(comment.edited_at).toLocaleString()}` }, "edited"), comment.isShared && /* @__PURE__ */ import_react5.default.createElement("span", { className: "komently-shared-badge", title: "This comment has been shared" }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.Share2, { size: 12 })), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-spacer" }), comment.user_id === currentUserId && !comment.deleted_at && /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, onEdit && /* @__PURE__ */ import_react5.default.createElement(Button, { onClick: () => setShowEdit(true), className: "komently-icon-btn", title: "Edit" }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.Edit, { size: 14 })), onDelete && /* @__PURE__ */ import_react5.default.createElement(Button, { onClick: () => onDelete(comment.id), className: "komently-icon-btn", title: "Delete" }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.Trash2, { size: 14 })))), !collapsed && /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, comment.deleted_at ? /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-deleted-badge" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "komently-deleted-text" }, "This comment is deleted by ", comment.deletion_type === "moderator" ? "moderator" : "commenter")) : showEdit && onEdit ? /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement(
    Textarea,
    {
      value: editText,
  ...
  ), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-actions" }, /* @__PURE__ */ import_react5.default.createElement(
    Button,
    {
      onClick: async () => {
    ...
    setShowEdit(false);
    setEditText(comment.comment);
  }, className: "komently-button" }, "Cancel"))) : /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-comment-body" }, comment.comment), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-comment-toolbar" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-vote" }, /* @__PURE__ */ import_react5.default.createElement(Button, { type: "button", className: `komently-vote-btn ${likeState === 1 ? "is-active" : ""}`, onClick: () => onLike?.(comment.id, likeState === 1 ? 0 : 1) }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.ArrowBigUp, { size: 14 })), /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-score", title: `+${likes} / -${dislikes}` }, total), /* @__PURE__ */ import_react5.default.createElement(Button, { type: "button", className: `komently-vote-btn ${likeState === -1 ? "is-active" : ""}`, onClick: () => onDislike?.(comment.id, likeState === -1 ? 0 : -1) }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.ArrowBigDown, { size: 14 }))), /* @__PURE__ */ import_react5.default.createElement(Button, { type: "button", onClick: () => setShowReply((s) => !s), className: "komently-icon-btn", title: "Reply" }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react2.MessageSquare, { size: 14 }), /* @__PURE__ */ import_react5.default.createElement("span", null, "Reply"))), showReply && /* @__PURE__ */ import_react5.default.createElement("div", { className: "komently-reply-form" }, /* @__PURE__ */ import_react5.default.createElement(
    Textarea,
    {
      value: text,
    ...
    "Post"
  ), /* @__PURE__ */ import_react5.default.createElement(Button, { onClick: () => setShowReply(false), className: "komently-button" }, "Cancel"))))));
}
var CommentItem = import_react5.default.memo(CommentItemBase);

// src/components/CommentSection.tsx
function CommentSection(props) {
  const { publicId, apiKey, baseUrl } = props;
  const client = (0, import_react6.useMemo)(() => new KomentlyClient({ apiKey, baseUrl }), [apiKey, baseUrl]);
  const [comments, setComments] = (0, import_react6.useState)([]);
  const [nextCursor, setNextCursor] = (0, import_react6.useState)(null);
  ...
  const [collapsedIds, setCollapsedIds] = (0, import_react6.useState)({});
  const toggleCollapse = (0, import_react6.useCallback)((id) => {
    setCollapsedIds((prev) => ({ ...prev, [id]: !prev[id] }));
  }, []);
  const [currentUser, setCurrentUser] = (0, import_react6.useState)(null);
  const [viewerId, setViewerId] = (0, import_react6.useState)(null);
  const [sectionSettings, setSectionSettings] = (0, import_react6.useState)({});
  ...
  const refreshAuth = (0, import_react6.useCallback)(async () => {
  ...
  const handleLogin = (0, import_react6.useCallback)(async () => {
  ...
  const handleReply = (0, import_react6.useCallback)(
    async (parentId, text) => {
  ...
  const handleLike = (0, import_react6.useCallback)(
  ...
  const handleDislike = (0, import_react6.useCallback)(
    async (commentId, state) => {
  ...
  const renderOne = (comment) => {
    ...
    return /* @__PURE__ */ import_react6.default.createElement(CommentItem, { ...common });
  };
  const renderChildren = (node) => {
    const children = node?.replies || [];
    if (!children || children.length === 0) return null;
    return /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-replies" }, children.map((r) => /* @__PURE__ */ import_react6.default.createElement("div", { key: r.id }, renderOne(r), !collapsedIds[r.id] && renderChildren(r))));
  };
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-comment-section" }, (props.renderForm || ((args) => /* @__PURE__ */ import_react6.default.createElement(CommentForm, { ...args })))({
  ...
  }), loading && /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-loading" }, "Loading comments\u2026"), error && /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-error" }, error), !loading && !error && comments.length === 0 && /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-empty" }, "No comments yet. Be the first to comment!"), /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-replies" }, comments.filter((c) => !c.reply_to).map((c) => /* @__PURE__ */ import_react6.default.createElement("div", { key: c.id }, renderOne(c), !collapsedIds[c.id] && renderChildren(c)))), nextCursor && /* @__PURE__ */ import_react6.default.createElement("div", { className: "komently-actions" }, /* @__PURE__ */ import_react6.default.createElement(Button, { type: "button", onClick: loadMore, disabled: loadingMore }, loadingMore ? "Loading\u2026" : "Load more comments")));
}
